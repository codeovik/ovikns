    ...
    if (event.type === "checkout.session.completed") {
        ...
        try {
            ...
            if (session.customer_details?.email) {
                ...
                const customerName = user?.name || order?.user?.name || session.customer_details.name || "Customer"
                    ...
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
                        ...
                        <div style="padding: 30px 20px;">
                            ...
                            <p style="color: #555; text-align: center; font-size: 16px; line-height: 1.6;">
                                ...
                                We are processing your ordered product and will notify you once it's shipped.
                            </p>
                            <p style="color: #555; text-align: center; font-size: 16px; line-height: 1.6;">
                                You can view your order details and track your shipment by logging into your account on our website.
                            </p>
                            <div style="text-align: center; margin-top: 30px;">
                                <a href="https://ovikns.web.app/orders/${orderId}" style="display: inline-block; background-color: #8c52ff; color: #ffffff; padding: 12px 50px; border-radius: 10px; text-decoration: none; font-size: 16px;">View Order</a>
                            </div>
