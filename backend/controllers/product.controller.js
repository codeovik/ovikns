...
export const createProduct = async (req, res) => {
  ...
  // ৪. ডাটাবেসে সেভ করা (আপনার মডেল অনুযায়ী ফিল্ডগুলো সাজানো)
  const newProduct = new Product({
    id: Number(id), // এখানে id (Number) ব্যবহার করা হয়েছে
    title,
    price: parsedPrice,
    discount: parsedDiscount,
    finalPrice: calculatedFinalPrice,
    category,
    color: Array.isArray(color) ? color : [color], // color হ্যান্ডেল করার জন্য
    images: imageUrls,
    description,
  });
